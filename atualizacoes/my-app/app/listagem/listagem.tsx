...
export default function ProductPage() {
  ...
  const updateRedirectPage = (id : string) => {
        ...
        <div className='p-8'>
          <div className=" mb-8 px-4">
            ...
            <div className='flex justify-end gap-5'>
              <button onClick={() => router.push('/listAlbByArtist')} className='cursor-pointer hover:bg-indigo-950 hover:scale-105 hover:shadow-lg text-white font-medium bg-indigo-500 rounded-full p-3 '>Albuns por artista</button>
